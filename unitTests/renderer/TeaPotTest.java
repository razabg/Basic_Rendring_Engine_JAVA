...
public class TeaPotTest {
    ...
    private final Scene scene = new Scene.SceneBuilder("Test scene").setLights(LightSourceInit).build();
    ...
    public void teapot() {
        ...
        scene.lights.add(new PointLight(new Color(500, 500, 500), new Point(100, 0, -100)).set_kQ(0.000001));

      scene.geometries.BuildTree();

          Camera camera = new Camera.CameraBuilder(new Point(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, 1, 0))
                  .setRayTracer(new RayTracerBasic(scene).set_bb(true))
